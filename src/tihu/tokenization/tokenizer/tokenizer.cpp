...
bool CTokenizer::Load(const std::string  &filename)
{
...
void CTokenizer::ParsText(CCorpus* corpus)
{
    ...
    while(1) {
        ...
        case TIHU_TOKEN_TYPE::DELIMITER: { //
            /// ignore delimiters
            /// White spaces (space, tab, new line, and carriage return) can be viewed as separators.
