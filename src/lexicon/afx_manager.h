 ...
 *
 *******************************************************************************/
#ifndef __TIHU__AFX_MANAGER_H
#define __TIHU__AFX_MANAGER_H
...
public:
  ...
  void AffixCheck(const char *text, int len, const FLAG needflag,
                  CWordPtr &word);

  void PrefixCheck(const char *text, int len, const FLAG needflag,
                   CWordPtr &word);

  void SuffixCheck(const char *text, int len, CPfxEntry *pfx,
                   const FLAG needflag, CWordPtr &word);

  bool IsPrefix(const char *prefix);

  void ParsEntry(struct hentry *he, CPfxEntry *pfx, CSfxEntry *sfx,
                 CWordPtr &word);
