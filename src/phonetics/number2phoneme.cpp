...
const char SegSuffix[][16] = {"hezAr",   //
                              "melyon",  //
                              "melyArd", //
                              "bilyon",  //
                              "bilyArd", "trilyun", "trilyArd"};
...
const char DahganDigits[][16] = {
    "_", "bist", "si", "Cehel", "panjAh", "Sast", "haftAd", "haStAd", "navad",
};

char SadganDigits[][16] = {
    "sad",    "devist",  "sisad",   "CAhArsad", "pAnsad",
    "SeSsad", "haftsad", "haStsad", "nohsad",
};
...
#define SEG_APPENDER "o"
  ...
  // Calculates segments count, each segments has 3 letter and cut from right of
  // text
